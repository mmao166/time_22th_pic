...
<div id="time_head" {if $_GET['diy'] == 'yes' && check_diy_perm($topic)}class="hides"{/if}>
  <div id="time_bar" class="cl"> 
    <!--{hook/global_cpnav_top}-->
    <div class="wp"> 
      <!-- 站点LOGO -->
      <div class="time_logo"> 
        <!--{eval $mnid = getcurrentnav();}-->
        <h2><a href="portal.php" title="$_G['setting']['bbname']"><img src="template/time_22th_pic/src/logo.png"></a></h2>
      </div>
      <!-- 导航 -->
      <div class="nav">
        <ul>
      ...
      <div class="yp-header-user-box">
        <div class="yp-header-user">
          <div class="user-main ">
            <div class="avatar"> <img src="template/time_22th_pic/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname">{$_G[member][username]}</span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
        ...
        <div class="yp-header-user">
          ...
          <div class="user-link">
            <ul>
              ...
              <li class="l2"><a href="member.php?mod={$_G[setting][regname]}" ><i></i>注册</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<div id="toptb" class="cl" style="display: none;">
  <div class="wp">
    ...
    <div class="y"> <a id="switchblind" href="javascript:;" onClick="toggleBlind(this)" title="{lang switch_blind}" class="switchblind">{lang switch_blind}</a> 
